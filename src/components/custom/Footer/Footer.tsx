      ...
      <div className="bg-[#41C2EC] py-10 px-4 sm:px-20 flex justify-between flex-col sm:flex-row gap-y-5">
        ...
        <div>
          ...
          <ul className="mt-2 flex items-center gap-3">
            ...
            <li className="mt-1">
              <Image src={Ppay} alt="" width={50} height={50} />
            </li>
            <li className="mt-1">
              <Image src={Paytm} alt="" width={50} height={50} />
            </li>
          </ul>
          <ul className="mt-2 flex items-center gap-3">
            <li>
              <Image src={Rupay} alt="" width={50} height={50} />
            </li>
            <li className="mt-1">
              <Image src={Visa} alt="" width={50} height={50} />
            </li>
            <li className="mt-1">
              <Image src={MCard} alt="" width={50} height={50} />
            </li>
          </ul>
          <ul className="mt-2 flex items-center gap-3">
            <li>
              <Image src={APay} alt="" width={50} height={50} />
            </li>
            <li className="mt-1">
              <Image src={Paypal} alt="" width={50} height={50} />
            </li>
            <li className="mt-1">
              <Image src={Mestro} alt="" width={50} height={50} />
            </li>
          </ul>
        </div>
      </div>
