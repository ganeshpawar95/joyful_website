    ...
    return (
        <div className="shadow-sm p-3 md:p-4 rounded-md bg-white">
            ...
            <div className="flex justify-between mt-3">
                <h4 className="text-sm font-medium text-gray-600 truncate w-1/2">Test name user name hello world</h4>
                <h4 className="text-sm font-medium text-gray-600 w-1/2">Jan 07, 2025</h4>
            </div>
        </div>
    )
}
